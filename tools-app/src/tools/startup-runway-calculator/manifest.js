export const startupRunwayCalculatorManifest = {
  ...
  seo: {
    ...
    keywords: 'startup runway calculator, cash runway calculator, net burn rate calculator, startup burn multiple, zero cash date, venture capital runway benchmark, calculate runway months, saas runway model',
    ogImage: 'https://tools.cerilas.com/og-image.svg',
    ogImageAlt: 'Cerilas Startup Runway and Cash Burn Calculator',
