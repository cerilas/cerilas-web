export const tokenCounterUniversalManifest = {
  ...
  features: [
    'Universal Multi-Model Support: Count tokens for GPT-4o, o1, o3-mini, Claude 3.7/3.5, Gemini 2.0/1.5, DeepSeek-V3/R1, and Llama 3.3',
    ...
    'Live Context Window Gauge: Visual usage meters for 128k, 200k, 1M, and 2M token context windows with overflow warnings',
    '2026 API Cost Calculator: Instant prompt input cost and 1K-completion cost estimates across 16+ frontier AI models',
  ...
  seo: {
    title: 'Free Universal Token Counter (2026) – OpenAI, Claude, Gemini, DeepSeek & Llama | Cerilas Tools',
    description: 'Calculate tokens, context window capacity, and API costs for text and documents (PDF, Code, TXT) across GPT-4o, Claude 3.7, Gemini 2.0 Flash, DeepSeek-V3, and Llama 3. Interactive color-coded visualizer.',
    keywords: 'token counter, universal token counter, openai token counter, gpt-4o token counter, claude token counter, gemini token counter, deepseek token counter, llama 3 token counter, pdf token counter, code token counter, tiktoken online, free token counter, context window calculator, llm cost calculator, token visualizer, token to word converter, o200k tokenizer online, cl100k tokenizer',
