export const arrCalculatorManifest = {
  ...
  seo: {
    ...
    keywords: 'arr calculator, annual recurring revenue calculator, mrr to arr, rule of 40 calculator, arr per employee, saas valuation calculator, average contract value acv, b2b saas financial model',
    ogImage: 'https://tools.cerilas.com/og-image.svg',
    ogImageAlt: 'Cerilas Annual Recurring Revenue ARR Calculator',
