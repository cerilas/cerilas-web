export const llmsTxtManifest = {
  ...
  seo: {
    title: 'LLMs.txt Generator, Checker & Validator – v2 Specification Suite | Cerilas Tools',
    description: 'Free online LLMs.txt Generator, Checker, and Validator. Create structured llms.txt guides for AI agents, audit link health, and validate formatting under the latest specification.',
    keywords: 'llms.txt generator, llms.txt checker, llms.txt validator, llmstxt org v2, create llms.txt online, validate llms.txt format, test llms.txt links, rel describedby llms.txt, text markdown alternative, ai agent site guide, cerilas tools',
    ogImage: 'https://tools.cerilas.com/tool-icons/llms-txt.png',
    ogImageAlt: 'Cerilas Free LLMs.txt Generator, Checker & Validator Suite',
    breadcrumbsName: 'LLMs.txt Tools'
  }
};
